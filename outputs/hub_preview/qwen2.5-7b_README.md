...
|--------|:-----:|
| **ATE Exact F1** | 0.7077 |
| **ATE Partial F1** | 0.8022 |
| **Pair F1** (aspect + sentiment) | 0.6448 |
| **Sentiment Accuracy** | 0.9110 |
| **Sentiment Macro-F1** | 0.8622 |
...
| Best eval loss | 0.1756 |
| Training time | 64.7 min |
