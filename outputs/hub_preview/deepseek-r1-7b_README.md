...
|--------|:-----:|
| **ATE Exact F1** | 0.6776 |
| **ATE Partial F1** | 0.7874 |
| **Pair F1** (aspect + sentiment) | 0.6034 |
| **Sentiment Accuracy** | 0.8905 |
| **Sentiment Macro-F1** | 0.8314 |
| **JSON Parse Rate** | 96.88% |
...
| Max seq length | 2048 |
| Seed | 42 |
| Final train loss | 0.2507 |
| Best eval loss | 0.1744 |
| Training time | 107.4 min |
