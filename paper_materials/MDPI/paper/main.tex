...
This research is organized into three research questions. First, it examines to what degree fine-tuning with parameter efficiency using QLoRA allows for an open-source large language model to conduct joint aspect extraction and sentiment classification tasks for Uzbek. Second, the chosen models are analyzed through identical QLoRA tuning conditions, and the question of whether validation loss reliably predicts downstream task performance is examined. Third, the research will determine to what degree a model trained only on restaurant reviews can produce annotations across a wider range of business types, and what impact domain distance has on annotation quality.
