...
\newcommand{\orcidauthorD}{0000-0002-0369-6707} % Add \orcidD{} behind the author's name

% Authors, for the paper (add full first names)
\Author{Sanatbek Matlatipov $^{1,}$*\orcidA{}, Gusein Djalilov $^{2}$\orcidB{}, Mersaid Aripov $^{1}$\orcidC{} and Jaloliddin Rajabov $^{1}$\orcidD{}}

%\longauthorlist{yes}

% MDPI internal command: Authors, for metadata in PDF
\AuthorNames{Sanatbek Matlatipov, Gusein Djalilov, Mersaid Aripov and Jaloliddin Rajabov}

%\longauthorlist{yes}

% Affiliations / Addresses (Add [1] after \address if there is only one affiliation.)
\address{%
$^{1}$ \quad Faculty of Applied Mathematics and Intelligent Technologies, National University of Uzbekistan named after Mirzo Ulugbek, Tashkent 100174, Uzbekistan; s.matlatipov@nuu.uz (S.M.); mirsaid.aripov@nuu.uz (M.A.); TODO-RAJABOV-EMAIL (J.R.)\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\authorcontributions{Conceptualization, S.M. and M.A.; methodology, S.M. and M.A.; software, S.M.; validation, S.M., G.D. and J.R.; formal analysis, S.M. and G.D.; investigation, S.M., G.D. and J.R.; resources, S.M.; data curation, S.M. and J.R.; writing---original draft preparation, S.M.; writing---review and editing, S.M., G.D., M.A. and J.R.; visualization, S.M.; supervision, M.A.; project administration, S.M.; funding acquisition, not applicable. All authors have read and agreed to the published version of the manuscript.}
